<p align="center">
  <img src="https://raw.githubusercontent.com/AmirCollider/AmirCollider-App/main/Logo.png" alt="App Screenshot" width="40%" />
</p>
...
**AmirCollider App** is a fully animated, dual-language Android application built in Unity.  
It features smooth UI transitions, a custom loading system, local/global server fallback, and dynamic content refresh.
...
**AmirCollider App** یک برنامه اندرویدی دو زبانه است که با Unity ساخته شده.  
دارای انیمیشن‌های روان، رابط کاربری جذاب، سیستم لودینگ حرفه‌ای، پشتیبانی از سرور محلی/گلوبال و به‌روزرسانی محتوای پویاست.
...
🌍 The Global Server is disabled due to budget constraints.  
💖 You can help us bring it back and keep the project alive.  

📎 Donate: [https://reymit.ir/amircollider](https://reymit.ir/amircollider)
...
🌍 سرور گلوبال به دلیل محدودیت‌های مالی فعلاً غیرفعاله.  
💖 با حمایت شما، می‌تونیم دوباره فعالش کنیم و پروژه رو گسترش بدیم.

📎 لینک دونیت: [https://reymit.ir/amircollider](https://reymit.ir/amircollider)
